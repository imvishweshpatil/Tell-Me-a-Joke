...
export default function ProgrammingJoke() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#750E21] to-black p-6">
      <div className="w-full max-w-md bg-white text-black shadow-2xl rounded-3xl p-8 border-4 border-pink-300">
        ...
        {joke ? (
          ...
          <p className="text-center text-gray-600 text-2xl">Compiling laughter💻😂👩</p>
        )}
